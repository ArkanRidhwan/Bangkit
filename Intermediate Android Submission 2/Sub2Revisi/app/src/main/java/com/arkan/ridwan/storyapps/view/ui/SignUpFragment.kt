...
import com.arkan.ridwan.storyapps.databinding.FragmentSignUpBinding
...
class SignUpFragment : Fragment(R.layout.fragment_sign_up) {
        ...
        when {
            ...
            password.isEmpty() -> {
                ...
                if (checkEmail(email) && password.length >= 6) {
                    ...
                    Toast.makeText(
                        requireActivity(),
                        "Silakan Isi Field Dengan Benar",
                        Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    private fun playAnimation() {
        ...
        val masukMessage =
            ObjectAnimator.ofFloat(binding.masukMessage, View.ALPHA, 1f).setDuration(500)
